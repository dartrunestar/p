...
public class HomeFragment extends Fragment implements OnClickListener{
    ...
    public double cash = PhotosFragment.getCash();
	 ...
	 private void buyStock()
	 {
		 try
		 {
			 ...
			 {		 
			 	...
			 	if (cash > y*price)
			 	{
			 		String open = PhotosFragment.getSymbol0();
			 		if (open.isEmpty())
			 		{
			 		textview2.setText("Purchase successful");
			 		PhotosFragment.setCash(cash - y*price);
			 		PhotosFragment.setSymbol0(textBox.getText().toString());
			 		PhotosFragment.setQuantity0(x);
			 		PhotosFragment.setRadioOn0True();
			        textview.setText(String.format("%.2f", cash - y*price));
			 		...
			 		else
			 		{
				 		textview2.setText("Purchase successful");
				 		PhotosFragment.setCash(cash - y*price);
				 		PhotosFragment.setSymbol1(textBox.getText().toString());
				 		PhotosFragment.setQuantity1(x);
				 		PhotosFragment.setRadioOn1True();
				        textview.setText(String.format("%.2f", cash - y*price));
			 		}
			 	}
			 	else
